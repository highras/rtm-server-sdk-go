...
func (client *RTMServerClient) GetGroupChat(groupId int64, desc bool, num int16,
	...
	return client.GetGroupMessage(groupId, desc, num, begin, end, lastid, append(rest, []int8{30})...)
}
...
func (client *RTMServerClient) GetRoomChat(roomId int64, desc bool, num int16,
	...
	return client.GetRoomMessage(roomId, desc, num, begin, end, lastid, append(rest, []int8{30})...)
}
...
func (client *RTMServerClient) GetBroadcastChat(desc bool, num int16,
	...
	return client.GetBroadcastMessage(desc, num, begin, end, lastid, append(rest, []int8{30})...)
}
...
func (client *RTMServerClient) GetP2PChat(uid int64, peerUid int64, desc bool, num int16,
	...
	return client.GetP2PMessage(uid, peerUid, desc, num, begin, end, lastid, append(rest, []int8{30})...)
}
...
func (client *RTMServerClient) DelChat(mid int64, fromUid int64, xid int64, messageType MessageType, rest ... interface{}) error {
	return client.DelMessage(mid, fromUid, xid, messageType, rest...)
}
